...
if __name__ == '__main__':
    # sys_root = expanduser('/files')
    local_root = '/home/swastik/IS/python-ransomware/files'
    if os.path.exists("/home/swastik/IS/python-ransomware/files1/file1.txt"):
        os.remove("/home/swastik/IS/python-ransomware/files1/file1.txt")
